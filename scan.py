...
PATH_TO_SAVED_MODEL = 'data/models/ssd_resnet50_v1_fpn_640x640_coco17_tpu-8' + "/saved_model"
...
# Load Label map
category_index = label_map_util.create_category_index_from_labelmap('data/mscoco_label_map.pbtxt',
